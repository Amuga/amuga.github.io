export const conditions: { [key: string]: string[] } = {
    tabs: ['ranger die to a sneeze (ranger die before day 6)','Ranger Muton Aggro','AI Derp','Sawmill Bop',
    ...
    'baby screams/cry', 'camcorder', 'dead phone/no signal', 'tinnitus sound effect' , 'Hunting trophy', 'Secret room', 'Music box', 'VHS tapes', 'Locked in a room', 'Door knock/rattle', 'Cuckoo clock', 'Masks' 
   ]
